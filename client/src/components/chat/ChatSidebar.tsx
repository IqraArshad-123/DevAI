    ...
    <aside className="flex h-full w-72 shrink-0 flex-col border-r border-white/10 bg-[#080c1d]">
      ...
      <div className="border-b border-white/10 p-4">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-white">Dev AI</h2>

            <p className="text-xs text-slate-500">AI Developer Assistant</p>
          </div>
        </div>
...
===================================================== */}
        ...
        <div className="border-b border-white/10 p-3">
          ...
          >
            ...
            <div className="pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-violet-500/10 blur-2xl transition-all duration-300 group-hover:bg-violet-500/20" />

            <div className="relative flex items-center gap-3">
              {/* ICON */}

              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-violet-400/20 bg-linear-to-br from-violet-600/30 to-blue-500/20 text-xl shadow-inner shadow-violet-500/10 transition-transform duration-300 group-hover:scale-105">
                📝
              </div>
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-full border border-violet-400/20 bg-violet-500/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-violet-300">
                    Workspace
                  </span>
                </div>

                <p className="mt-1 truncate text-[11px] text-slate-500 transition-colors group-hover:text-slate-400">
                  Capture ideas & snippets
                </p>
              </div>

              {/* ARROW */}

              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/5 bg-white/5 text-slate-500 transition-all duration-300 group-hover:translate-x-0.5 group-hover:border-violet-400/20 group-hover:bg-violet-500/10 group-hover:text-violet-300">
                →
              </div>
            </div>
          </button>
                    ...
                    >
                      <div
                        className={`truncate text-sm font-medium ${
                          isActive ? "text-violet-200" : "text-slate-300"
                        }`}
                      >
                        {conversation.title}
                      </div>
      ...
      <div className="border-t border-white/10 p-4">
        <div className="rounded-xl border border-white/5 bg-white/3 px-3 py-3">
          <p className="text-xs text-slate-500">Dev AI</p>
